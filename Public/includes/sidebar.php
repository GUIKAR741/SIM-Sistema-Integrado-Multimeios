<aside id="slide-out" class="side-nav white">
    <div class="side-nav-wrapper">
        ...
        <div class="sidebar-account-settings">
            <ul>
                <li class="no-padding">
                    <a class="waves-effect waves-grey"><i class="material-icons">settings</i>Configurações</a>
                </li>
                <li class="no-padding">
                    <a class="waves-effect waves-grey"><i class="material-icons">mail_outline</i>Manual</a>
                </li>
                <li class="divider"></li>
                <li class="no-padding">
        ...
        <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
            <li class="no-padding active"><a class="waves-effect waves-grey active" href="index.html"><i class="material-icons">settings_input_svideo</i>Painel</a></li>
            <li class="no-padding">
