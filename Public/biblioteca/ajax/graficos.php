...
if (isset($_POST['lidos']) && $_POST['lidos']=='true'):
    #livros
...
if (isset($_POST['leitores']) && $_POST['leitores']=='true'):
    $i=0;
    $leitores['labels']="leitores";
...
if (isset($_POST['turmas']) && $_POST['turmas']=='true'):
    #turmas
    ...
    foreach ($turma as $index => $item) {
        ...
        $turmas[$j]['labels']=$curso->serie.'º '.$curso->nome_curso;
        $i=0;
