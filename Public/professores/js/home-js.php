...
<script>
    $(document).ready(function() {
        $('#enviar-ajax').click(function () {
            ...
            let hora=[], recur=[], turma = [],  valida=[], cont_hora=0, cont_recur=0, cont_turm=0, cont_valida=0;
            ...
            if (cont_valida===4){envia(data,hora,recur,turma);}
        });
        let envia=function (data,horario,recurso,turmas){$.ajax({
            url:"ajax/cadastro.php",
            type: "POST",
            async: true,
            dataType: "JSON",
            data:{action:"true",data_submit:data,horario:horario,recurso:recurso,turmas:turmas},
