...
if (isset($_GET['sair']) || isset($_REQUEST['sair']) ):
    ...
    exit;
elseif ((!isset($_SESSION['logado']))||(!isset($_SESSION['nome'])||(!isset($_SESSION['email']))||($_SESSION['nivel']!='Professor')||($_SESSION['status']!='1'))):
...
if ((is_file("pages/" . $require . ".php"))):
    ...
    require_once("../includes/menu-professores.php");
    require_once("../includes/sidebar-professores.php");
