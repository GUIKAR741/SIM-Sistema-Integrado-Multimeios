...
//                    endfor;
//                    ?><!--                        --><?php
//                        $tipo=array("livro"=>"Total de Livros no Acervo","circulo"=>"Total de Livros do Circulo",
//                            "cd-dvd"=>"Total de CDs e DVDs","tves"=>"Total de CDs e DVDs da TV Escola","materiais"=>"Total de Materiais",
//                            "jmf"=>"Total de Arquivos JMF",);
//                        foreach ($tipo as $index=>$value) {
//                            $acervo=$tb_aluno->select("count(tipo_acervo) as 'count'")->from("tb_acervo")->where("tipo_acervo",$index)->first();
//                            echo "<div class=\"col s12 m12 l3\">
//                            <a href=\"?p=turma&id=\" ><div class=\"card stats-card\">
//                                <div class=\"card-content\" style=\"padding: 10px;\">
//                                    <div class=\"col l3\">
//                                        <span class=\"btn-floating btn-large btn-no-shadow cyan\">
//                                            <i class=\"large material-icons\" style=\"font-size: 2.5rem\">supervisor_account</i>
