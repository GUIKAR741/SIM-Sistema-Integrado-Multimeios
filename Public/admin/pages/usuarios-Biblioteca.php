                            ...
                            <tr>
                                ...
                                <td class="center no-m no-p-h">
                                    <div class="switch">
                                        <label>
                                            Desativado
                                            <input type="checkbox" id="check" onclick="setTimeout(function(){document.location='?p=usuarios-Biblioteca&status=<?=$value->idtb_usuario?>'},500);" <?php if ($value->status_usuario==0) echo 'checked';?>>
