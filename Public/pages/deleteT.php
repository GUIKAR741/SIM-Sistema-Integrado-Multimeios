...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            if (!empty(filter_input(INPUT_GET, 'idT', FILTER_DEFAULT))):
                $turma=new Turma();
                $id = filter_input(INPUT_GET, 'idT', FILTER_DEFAULT);
                $row=$turma->delete('id',$id);
                if ($row > 0):
                    ...
                    echo "<script> setTimeout('document.location = \'home.php?acao=turma\'',2000);</script>";
                else:
