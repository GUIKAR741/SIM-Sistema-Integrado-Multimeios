...
<!-- Team Section start -->
<section  class="scroll-section root-sec brand-bg padd-tb-60 team-wrap">
    <div class="container">
        <div class="row">
                    ...
                    <div class="row">
                        <div class="clearfix section-head team-text margin-b-0">
                            <div class="col-sm-12" id="team">
                                <h2 class="title">Livros em destaque</h2>
                            </div>
                        </div>
                        <div class="col-lg-12">
                                        ...
                                        <div class="col-sm-4 single-card-box wow fadeInUpSmall" data-wow-duration=".7s">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <span class="card-title activator brand-text">Percy Jackson<i class="mdi-navigation-more-vert right"></i></span>
                                                    <p>E o Ladrão de raios</p>
                                                </div>
                                                <div class="card-reveal">
                                                    <div class="rev-title-wrap">
                                                        <span class="card-title activator brand-text">Percy Jackson<i class="mdi-navigation-close right"></i></span>
                                                        <p>E o Ladrão de raios</p>
                                                    </div>
                                                    <p class="rev-content">
